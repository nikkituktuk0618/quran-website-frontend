...
import PlaylistVideos from "@/components/common/PlaylistVideos";
import { getCaller } from "@/lib/apiCaller";
import { loggedInUser } from "@/utils/constant";
    ...
    <section className="min-h-screen flex">
      ...
      <div className="min-h-screen w-full md:pl-[220px] pb-8">
        ...
        <div className="p-4">
          ...
          <PlaylistVideos courseData={playlist} />
        </div>
      </div>
    </section>
  );
