import { UserPanelNavList } from "@/utils/constant";
    ...
    <section className="min-h-screen flex">
      ...
      >
        <div className="relative">
          ...
          <div className="flex flex-col gap-1">
            {UserPanelNavList.map((item, index) => (
        ...
        <Link to={"/"}>
          <div className="px-2 py-4 border-t font-semibold cursor-pointer flex gap-2">
      ...
      <div className="min-h-screen w-full md:pl-[220px] pb-8">
        <nav className="w-full h-[50px] border-b flex justify-between md:justify-end gap-2 items-center px-5 md:px-10">
          ...
          <div>
            <span className="bg-blue-400 px-2 py-1 mr-2 rounded-full font-semibold">
              U
            </span>
